...
class Evaluator(object):
    def __init__(self, model, visiual=True,gan_model=None,test_path=cfg.TEST["DATASET_PATH"]):
        self.classes = cfg.DATA["CLASSES"]
        self.pred_result_path = os.path.join(cfg.PROJECT_PATH, 'data', 'results')
        self.val_data_path = test_path
    ...
    def APs_voc(self, multi_test=False, flip_test=False,direct_flag=False):
        ...
        for img_ind in tqdm(img_inds):
            img_path = os.path.join(self.val_data_path,cfg.TEST["DATASET_DIRECTORY"], img_ind+'.jpg')
