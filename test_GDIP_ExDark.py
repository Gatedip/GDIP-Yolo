...
from model.yolov3_gdip_customEncoder import Yolov3GatedDIP
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default='weights/gdip_yolo/best.pt', help='weight file path')
    parser.add_argument('--visiual', type=str, default='/home/sanket/workspace/dataset/RTTS/JPEGImages', help='test data path or None')
