...
from eval.evaluator_ExDark_GDIP import Evaluator
import argparse
import os
import config.yolov3_config_ExDark as cfg
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default='weights/gan_yolo/backup_epoch40.pt', help='weight file path')
    parser.add_argument('--visiual', type=str, default='/home/sanket/workspace/RRC/GANYolov3/code/yolov3/YOLOV3/data/VOCtest-2007/VOCdevkit/VOC2007/FLImages', help='test data path or None')
